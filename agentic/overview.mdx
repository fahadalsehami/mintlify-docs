...
<Card title="Clinician-facing assistants" icon="/icons/ui/stethoscope.svg">
Visit Scribe with in-encounter SOAP drafting, Co-Therapy multimodal in-session signal, CDI concurrent review.
</Card>

<Card title="Patient-facing voice agents" icon="/icons/ui/phone-call.svg">
...
<Card title="Programmatic agent endpoints" icon="/icons/ui/code.svg">
Embedded into existing clinical software via REST, triggered by events, APIs, or Medera Voice webhooks.
</Card>

<Card title="Customer-embedded agents" icon="/icons/ui/puzzle.svg">
