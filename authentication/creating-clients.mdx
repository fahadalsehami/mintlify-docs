...
Developer API Keys are managed in the [Medera Console](https://app.medera.info) under **Settings → Developer API Keys**.

<Steps>
  <Step title="Open the Console">
    Sign in to [app.medera.info](https://app.medera.info).
  </Step>
