...
- Carried into background workers via `executeInOrgScope` transaction context ## Environments | Environment | Host | Database | PHI |
| :--- | :--- | :--- | :--- |
...
| production | `api.medera.info` | Tenant-scoped under BAA | Real PHI + full audit + Merkle integrity | ## Tenant-scoped tables The following tables enforce tenant isolation via RLS (migrations 124, 125, 154): | Domain | Tables |
| :--- | :--- |
