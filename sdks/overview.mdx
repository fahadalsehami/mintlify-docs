...
<CardGroup cols={2}>
  <Card title="JavaScript / TypeScript SDK" icon="/icons/ui/square-code.svg" href="/sdks/js/overview">
    `@medera/sdk` for Node 18+, modern browsers, Bun, Deno, and edge runtimes (Cloudflare Workers, Vercel Edge).
  </Card>
  <Card title="Python SDK" icon="/icons/ui/square-code.svg" href="/sdks/python/overview">
    `medera` — async-first via httpx + Pydantic models. Python 3.10+.
  </Card>
  <Card title="Dictation Web Component" icon="/icons/ui/mic.svg" href="/sdks/dictation-component">
    `<medera-dictation>` — drop-in dictation UI with microphone management and command parsing.
  </Card>
  <Card title="Co-Therapy Web Component" icon="/icons/ui/users.svg" href="/sdks/co-therapy-component">
    `<medera-cotherapy>` — multimodal capture UI with private clinician channel.
  </Card>
  <Card title="Postman" icon="/icons/ui/package.svg" href="/sdks/postman">
    Pre-built Postman collection with the full Medera API.
  </Card>
  <Card title="CLI" icon="/icons/ui/terminal.svg" href="/sdks/cli">
...
<CardGroup cols={2}>
  <Card title="JavaScript SDK" icon="/icons/ui/square-code.svg" href="/sdks/js/overview">Install + first call.</Card>
  <Card title="Python SDK" icon="/icons/ui/square-code.svg" href="/sdks/python/overview">Install + first call.</Card>
  <Card title="Authentication" icon="/icons/ui/key.svg" href="/authentication/overview">Credential types + scopes.</Card>
  <Card title="API Reference" icon="/icons/ui/terminal.svg" href="/api-reference/welcome">Every endpoint.</Card>
</CardGroup>
