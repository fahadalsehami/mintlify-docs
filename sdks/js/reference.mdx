...
--- Full API reference for the JavaScript SDK. See the [TypeDoc-generated reference](https://docs.medera.info/sdks/js/typedoc) for typed schemas. ## MederaClient | Method | Description |
| :--- | :--- |
