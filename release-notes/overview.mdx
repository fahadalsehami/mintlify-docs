...
<CardGroup cols={2}>
<Card title="Platform" icon="/icons/ui/server.svg" href="/release-notes/platform">
Backend, runtime, RLS, audit, encryption.
</Card>
<Card title="Agentic Framework" icon="/icons/ui/layers.svg" href="/release-notes/agentic">
Canvas, agents, experts, orchestrator.
</Card>
<Card title="Multimodal Sensing" icon="/icons/ui/audio-lines.svg" href="/release-notes/multimodal">
Vocal, facial, Neurobehavioral Construct engines.
</Card>
<Card title="Text Generation" icon="/icons/ui/text-align-start.svg" href="/release-notes/textgen">
