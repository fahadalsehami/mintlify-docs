...
description: "Vocal, facial, RDoC engines"
---
...
- **RDoC Construct Computer** — `src/rdoc/rdoc_construct_computer.py` — 15 named constructs across 5 domains with zero overlap
