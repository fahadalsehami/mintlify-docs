...
<CardGroup cols={2}>
  <Card title="SNOMED CT" icon="/icons/ui/hashtag.svg" href="/coding/snomed-ct">Clinical terminology.</Card>
  <Card title="Coding systems" icon="/icons/ui/layers.svg" href="/coding/coding-systems">Feature matrix + pairings.</Card>
  <Card title="Encounter coding" icon="/icons/ui/clipboard-check.svg" href="/coding/encounter-coding">Use cases.</Card>
  <Card title="Validated screeners" icon="/icons/ui/clipboard.svg" href="/agentic/experts/validated-screener">Screener Expert.</Card>
</CardGroup>
