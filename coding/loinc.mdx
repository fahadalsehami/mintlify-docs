...
<CardGroup cols={2}>
  <Card title="SNOMED CT" icon="hashtag" href="/coding/snomed-ct">Clinical terminology.</Card>
  <Card title="Coding systems" icon="layers" href="/coding/coding-systems">Feature matrix + pairings.</Card>
  <Card title="Encounter coding" icon="clipboard-check" href="/coding/encounter-coding">Use cases.</Card>
  <Card title="Validated screeners" icon="clipboard" href="/agentic/experts/validated-screener">Screener Expert.</Card>
</CardGroup>
