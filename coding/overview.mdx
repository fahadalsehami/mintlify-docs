...
<CardGroup cols={4}>
  ...
  <Card title="CPT" href="/coding/cpt" icon="hashtag" horizontal>Outpatient procedure / E&M</Card>
  ...
  <Card title="LOINC" href="/coding/loinc" icon="hashtag" horizontal>Lab + instrument observations</Card>
  <Card title="RxNorm" href="/coding/rxnorm" icon="hashtag" horizontal>Psychotropic + general medication</Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Core Concepts" icon="book" href="/coding/introduction">Understand every field in the response.</Card>
  <Card title="How it works" icon="settings" href="/coding/how-it-works">Request structure + best practices.</Card>
  <Card title="Coding Systems" icon="layers" href="/coding/coding-systems">Feature availability per system.</Card>
</CardGroup>
