...
<CardGroup cols={4}>
  <Card title="ICD-10-CM" href="/coding/icd-10-cm" icon="/icons/ui/hashtag.svg" horizontal>US diagnosis</Card>
  <Card title="ICD-10-PCS" href="/coding/icd-10-pcs" icon="/icons/ui/hashtag.svg" horizontal>US inpatient procedure</Card>
  <Card title="ICD-10" href="/coding/icd-10-int" icon="/icons/ui/hashtag.svg" horizontal>WHO international</Card>
  <Card title="CPT" href="/coding/cpt" icon="/icons/ui/hashtag.svg" horizontal>Outpatient procedure / E&M</Card>
  <Card title="HCPCS Level II" href="/coding/hcpcs" icon="/icons/ui/hashtag.svg" horizontal>Non-physician services</Card>
  <Card title="SNOMED CT" href="/coding/snomed-ct" icon="/icons/ui/hashtag.svg" horizontal>Clinical terminology</Card>
  <Card title="LOINC" href="/coding/loinc" icon="/icons/ui/hashtag.svg" horizontal>Lab + instrument observations</Card>
  <Card title="RxNorm" href="/coding/rxnorm" icon="/icons/ui/hashtag.svg" horizontal>Psychotropic + general medication</Card>
</CardGroup>
...
<CardGroup cols={3}>
  <Card title="Encounter coding" icon="/icons/ui/clipboard-check.svg" href="/coding/encounter-coding">
    Assign accurate diagnosis and procedure codes to behavioral-health encounters using documentation-anchored suggestions.
  </Card>
  <Card title="Clinical Documentation Improvement" icon="/icons/ui/file-pen.svg" href="/coding/cdi">
    Surface missing specificity, severity qualifiers, and gaps as clinical queries before sign-off.
  </Card>
  <Card title="Revenue cycle" icon="/icons/ui/chart-line.svg" href="/coding/revenue-cycle">
...
<CardGroup cols={2}>
  ...
  <Card title="Core Concepts" icon="/icons/ui/book.svg" href="/coding/introduction">Understand every field in the response.</Card>
  <Card title="How it works" icon="/icons/ui/settings.svg" href="/coding/how-it-works">Request structure + best practices.</Card>
  <Card title="Coding Systems" icon="/icons/ui/layers.svg" href="/coding/coding-systems">Feature availability per system.</Card>
</CardGroup>
