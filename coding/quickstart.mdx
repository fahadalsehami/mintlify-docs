...
<Card title="Code Prediction" icon="/icons/ui/book.svg" href="/coding/introduction">
Endpoint, supported features, coding system options.
</Card>

<Card title="How it works" icon="/icons/ui/settings.svg" href="/coding/how-it-works">
Request schema, response fields, evidence spans, filtering.
</Card>

<Card title="Use cases" icon="/icons/ui/briefcase.svg" href="/coding/encounter-coding">
