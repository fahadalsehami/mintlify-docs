...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="zap" href="/coding/quickstart">Send your first request.</Card>
  <Card title="How it works" icon="settings" href="/coding/how-it-works">Request structure, best practices.</Card>
  <Card title="Coding Systems" icon="layers" href="/coding/coding-systems">Feature matrix per system.</Card>
  <Card title="Encounter Coding" icon="clipboard-check" href="/coding/encounter-coding">Use case walkthrough.</Card>
</CardGroup>
