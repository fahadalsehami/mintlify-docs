...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="/icons/ui/zap.svg" href="/coding/quickstart">Send your first request.</Card>
  <Card title="How it works" icon="/icons/ui/settings.svg" href="/coding/how-it-works">Request structure, best practices.</Card>
  <Card title="Coding Systems" icon="/icons/ui/layers.svg" href="/coding/coding-systems">Feature matrix per system.</Card>
  <Card title="Encounter Coding" icon="/icons/ui/clipboard-check.svg" href="/coding/encounter-coding">Use case walkthrough.</Card>
</CardGroup>
