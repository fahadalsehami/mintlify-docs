...
<Card title="Drug Interaction Agent" icon="/icons/ui/flask-conical.svg" href="/agentic/agents/drug-interaction">
DDI checking.
</Card>

<Card title="Medication Reconciliation" icon="/icons/ui/pill.svg" href="/agentic/agents/medication-reconciliation">
Reconciliation across sources.
</Card>

<Card title="Coding systems" icon="/icons/ui/layers.svg" href="/coding/coding-systems">
Feature matrix.
</Card>

<Card title="e-Rx network" icon="/icons/ui/link.svg" href="/api-reference/integrations/surescripts">
E-prescribing.
</Card>
</CardGroup>
