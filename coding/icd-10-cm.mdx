...
<CardGroup cols={2}>
  <Card title="CPT" icon="/icons/ui/hashtag.svg" href="/coding/cpt">Procedure + E/M.</Card>
  <Card title="HCPCS Level II" icon="/icons/ui/hashtag.svg" href="/coding/hcpcs">BH-specific H- and S-codes.</Card>
  <Card title="CDI" icon="/icons/ui/file-pen.svg" href="/coding/cdi">Documentation gaps.</Card>
