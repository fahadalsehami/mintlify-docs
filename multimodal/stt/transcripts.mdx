...
<CardGroup cols={2}>
  <Card title="/sessions — live capture" icon="audio-lines" href="/multimodal/stt/streams">Stateful diarized session.</Card>
  <Card title="/transcribe — dictation" icon="microphone" href="/multimodal/stt/transcribe">Between-visit dictation.</Card>
  <Card title="Audio configuration" icon="settings" href="/multimodal/stt/audio">Formats and limits.</Card>
  <Card title="Ambient async quickstart" icon="zap" href="/quickstart/ambient-async">End-to-end async walkthrough.</Card>
</CardGroup>
