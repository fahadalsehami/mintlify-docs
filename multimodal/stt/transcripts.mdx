...
<CardGroup cols={2}>
  ...
  <Card title="/transcribe — dictation" icon="/icons/ui/mic.svg" href="/multimodal/stt/transcribe">Between-visit dictation.</Card>
  <Card title="Audio configuration" icon="/icons/ui/settings.svg" href="/multimodal/stt/audio">Formats and limits.</Card>
  <Card title="Ambient async quickstart" icon="/icons/ui/zap.svg" href="/quickstart/ambient-async">End-to-end async walkthrough.</Card>
</CardGroup>
