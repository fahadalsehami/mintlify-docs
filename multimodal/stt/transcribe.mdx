...
<CardGroup cols={2}>
  <Card title="Commands" icon="terminal" href="/multimodal/stt/commands">Build voice commands.</Card>
  <Card title="Smart punctuation" icon="quote" href="/multimodal/stt/punctuation">Punctuation modes.</Card>
  <Card title="/sessions — live capture" icon="audio-lines" href="/multimodal/stt/streams">Stateful diarized session.</Card>
  <Card title="Microphones" icon="microphone-2" href="/multimodal/stt/microphones">Recommended hardware.</Card>
</CardGroup>
