...
<Card title="Diarization" icon="/icons/ui/users.svg" href="/multimodal/stt/diarization">
2-speaker separation.
</Card>

<Card title="Audio configuration" icon="/icons/ui/settings.svg" href="/multimodal/stt/audio">
