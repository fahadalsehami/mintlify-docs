...
--- Medera diarizes up to 4 speakers in conversational STT with sub-second labelling latency. ## How it works - Speaker embeddings extracted per voiced window
- Online clustering with minimum-cluster-duration heuristic
- Label stability via Viterbi smoothing
- Optional enrollment for known clinicians ## Enrollment ```bash
