...
--- ## `POST /api/intake-calls` Create an intake call record. Triggers Medera Voice assistant creation with the patient-specific runtime config and subscription enforcement. ### Request body ```json
...
``` ### Other endpoints | Method | Path | Purpose |
| :--- | :--- | :--- |
