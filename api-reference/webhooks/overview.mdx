...
--- Webhooks are delivered to a tenant-configured URL with signed headers. | Header | Description |
| :--- | :--- |
...
| Payer | Per-payer HMAC secret | ## Retry Failed deliveries retry with exponential backoff for 24 hours, then move to a dead-letter queue.