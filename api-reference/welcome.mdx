...
<Card title="Backend " icon="/icons/ui/server.svg" horizontal>
Tenant + PHI persistence, workflow + deployment lifecycle, EHR + billing integration, real-time channel.
</Card>

<Card title="AI Services " icon="/icons/ui/brain.svg" horizontal>
...
<Card title="Errors" icon="/icons/ui/circle-x.svg" href="/api-reference/errors">
Error format and common codes.
</Card>

<Card title="Rate Limits" icon="/icons/ui/gauge.svg" href="/api-reference/rate-limits">
Per-tenant limits.
</Card>

<Card title="Pagination" icon="/icons/ui/list.svg" href="/api-reference/pagination">
