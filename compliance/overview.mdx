...
<Card title="42 CFR Part 2" icon="shield-alert" href="/compliance/42-cfr-part-2">
...
<Card title="Audit Logging" icon="scroll" href="/compliance/audit-logging">
WORM audit + Merkle integrity.
</Card>

<Card title="Row-Level Security" icon="table" href="/compliance/row-level-security">
...
<Card title="HIPAA controls" icon="shield-check" href="/compliance/hipaa">
