...
<Card title="Standard documents" icon="/icons/ui/file-text.svg" href="/textgen/documents-standard">
Generate via template.
</Card>

<Card title="Specialty documents" icon="/icons/ui/file-pen.svg" href="/textgen/documents-advanced">
Enhanced + billing codes.
</Card>

<Card title="Facts & Reasoning" icon="/icons/ui/search.svg" href="/textgen/factsr">
Structured facts extraction.
</Card>

<Card title="Clinical RAG" icon="/icons/ui/library.svg" href="/textgen/rag-overview">
