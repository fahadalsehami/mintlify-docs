...
| Voice agent LLM | `gpt-4-turbo` | 0.3 | text (max 500 tokens) |

## What's next

<CardGroup cols={2}>
  <Card title="Standard documents" icon="file-text" href="/textgen/documents-standard">Generate via template.</Card>
  <Card title="Specialty documents" icon="file-pen" href="/textgen/documents-advanced">Enhanced + billing codes.</Card>
  <Card title="Facts & Reasoning" icon="search" href="/textgen/factsr">Structured facts extraction.</Card>
  <Card title="Clinical RAG" icon="library" href="/textgen/rag-overview">Hybrid evidence retrieval.</Card>
</CardGroup>
