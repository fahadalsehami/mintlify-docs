...
These fuse into 15 RDoC construct activations. See [RDoC Overview](/multimodal/rdoc/overview).
...
<CardGroup cols={2}>
  ...
  <Card title="Facial Engine" href="/multimodal/facial/overview">Physiological signals from video.</Card>
  <Card title="Vocal Engine" href="/multimodal/vocal/overview">Acoustic features from audio.</Card>
  <Card title="RDoC Constructs" href="/multimodal/rdoc/overview">15 documented constructs.</Card>
</CardGroup>
