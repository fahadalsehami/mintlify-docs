...
The [Medera Console](https://app.medera.info) is the self-service portal for tenant management, agent canvas, deployments, integrations, and billing.

## Sign up

<Steps>
  <Step title="Create an account">
    Visit [app.medera.info/signup](https://app.medera.info/signup). Authentication is handled by Clerk. New tenants start in the **sandbox** environment.
  </Step>
