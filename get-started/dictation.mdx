...
Dictation commands let the clinician control the editor by voice. See [Dictation Commands](/multimodal/stt/commands).
...
<CardGroup cols={2}>
  <Card title="Transcribe endpoint" href="/multimodal/stt/transcribe">Real-time stateless dictation.</Card>
  <Card title="Streams endpoint" href="/multimodal/stt/streams">Ambient + diarized encounter audio.</Card>
  <Card title="Commands" href="/multimodal/stt/commands">Voice command authoring.</Card>
  <Card title="Microphones" href="/multimodal/stt/microphones">Recommended hardware.</Card>
</CardGroup>
